...
addon_info = AddonInfo(
	...
	addon_name="OllamaImageDiscriber",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	addon_summary=_("OllamaImageDiscriber"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	addon_description=_("""An NVDA add-on that allows the user to get a discribtion of the current focussed item from an AI model with OLLAMA using a keyboard shortcut"""),
	# version
	addon_version="1.0",
	...
	# Author(s)
	addon_author="makhlwf",
	# URL for the add-on documentation support
	addon_url="https://github.com/makhlwf/OllamaImageDiscriber",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/makhlwf/OllamaImageDiscriber",
